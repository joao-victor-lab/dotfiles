...
local function jdtls_on_attach(client, bufnr)
  ...
  vim.keymap.set("x", "<A-v>", "<esc><cmd>lua require('jdtls').extract_variable(true)<cr>", opts)
  vim.keymap.set("n", "<leader>Jc", "<cmd>lua require('jdtls').extract_constant()<cr>", opts)
  vim.keymap.set("x", "<A-c>", "<esc><cmd>lua require('jdtls').extract_constant(true)<cr>", opts)
  vim.keymap.set("x", "<A-m>", "<esc><Cmd>lua require('jdtls').extract_method(true)<cr>", opts)
end
