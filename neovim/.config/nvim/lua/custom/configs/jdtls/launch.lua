...
function M.setup()
  ...
  config.cmd = {
    --
    -- 				-- 💀
    home .. "/.asdf/installs/java/openjdk-21.0.2/bin/java", -- or '/path/to/java17_or_newer/bin/java'
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = "JavaSE-17",
            path = vim.fn.expand "~/.asdf/installs/java/oracle-17.0.10",
          },
          {
            name = "JavaSE-21",
  ...
  require "custom.configs.jdtls.mappings"
